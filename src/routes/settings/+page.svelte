            ...
            .then(
                (json: {
                    ...
                    const vision = json.data
                        .filter(
                            (m) =>
                                m.architecture?.input_modalities?.includes(
                                    "image",
                                ) ||
        ...
        {#if aiProvider === "anthropic"}
            <label for="claude-key">
                ...
                <span
                    ...
                    role="img"
                    aria-label={claudeApiKeySaved ? "saved" : "not saved"}
                    >●</span
                >
            </label>
            <input
        ...
        {:else}
            <label for="or-key">
                ...
                <span
                    ...
                    role="img"
                    aria-label={openrouterApiKeySaved ? "saved" : "not saved"}
                    >●</span
                >
            </label>
            <input
            ...
            {:else if orModelsFailed || orModels.length === 0}
                ...
                />
                <p class="hint">
                    Browse vision-capable models at openrouter.ai/models
                </p>
            {:else}
